        ...
        <div className="card" ref={card} data-state="#about">
            <div className="card-header">
                <div className="card-cover" style={{backgroundImage: `url(${aboutBack})`}}></div>
                    <img className="card-avatar" src={`${profilePic}`} alt="avatar" loading="eager"/>
            ...
            <div className="card-main">
                ...
                <div className="card-content">
                    ...
                    <p className="card-desc">Hi, are you curious to find out more about me? Well, then let's get started. As I think you may have noticed I have a soft spot for design and creativity, I always try to bring this into every job I do, but there's not only this to know about me. I am a great lover of challenges and knowledge, for this very reason I have a lot of transferable knowledge with respect to my profession, if you are still interested in knowing more about me click the "JOURNEY" button to have a full view of my story in the world of development. Oh and do not forget to check my socials.
                    </p>
                </div>
                <div className="card-social">
                    <a href="https://twitter.com/NightSky1100"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <a href="https://www.instagram.com/__therealnightsky__/"><svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.linkedin.com/in/cristian-musto/"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="card-content">
                    ...
                    <div className="card-item" data-year="2024">
                        <div className="card-item-title">Swift Course by <span>Udemy</span></div>
